...
while True:
        ...
        while not coords_picked:
                ...
                pts_dst = np.float32([[0, 0], [screen_width - 1, 0], [0, screen_height - 1], [screen_width - 1, screen_height - 1]])
                ...
                # Warp the frame using the calculated matrix
                frame_out = cv.warpPerspective(frame, M, (screen_width, screen_height))
